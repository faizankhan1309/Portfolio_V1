            ...
            return (
              ...
              >
                ...
                <img
                  ...
                  alt=""
                  aria-hidden="true"
                  className="hidden md:block absolute top-1/2 -translate-y-1/2 h-[90%] w-[350px] object-cover rounded-lg opacity-20 blur-sm z-0 pointer-events-none select-none drop-shadow-[0px_0px_10px_rgba(251,146,60,0.3)]"
                  style={{
                ...
                >
                  <div data-card-id={item.id} className="flex flex-col flex-1 p-6 gap-4">
                    ...
                    {/* Description */}
                    <p
                      className="text-base md:text-base text-gray-400 leading-relaxed line-clamp-2"
