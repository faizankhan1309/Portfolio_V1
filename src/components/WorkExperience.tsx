...
const experiences: Experience[] = [
  ...
  },
  {
    id: 6,
    role: 'Co-founder',
    company: 'Pixel Room - LNCT Bhopal',
    type: null,
...
export const WorkExperience = () => {
  ...
  return (
    <section id="work-experience" className="relative py-24 px-6 overflow-hidden">
      ...
      <div ref={ref} className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <p
            className="text-sm font-medium tracking-widest uppercase text-red-600/70 mb-4"
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-[5fr_8fr] gap-5 transition-all duration-1000 delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
          }`}
        >
            ...
            {experiences.map((exp, index) => {
              ...
              return (
                <button
                  ...
                  className={`
                    w-full text-left flex items-center gap-4 px-4 py-4 rounded-xl border
                ...
                >
                  ...
                  <span
                    className={`
                      ...
                      ${isActive
                        ? 'bg-gradient-to-br from-red-500 to-red-600 shadow-[0_0_14px_rgba(0,240,255,0.45)]'
                        : 'bg-white/10'
                      }
                    `}
                  >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p
                      className={`text-sm truncate mt-0.5 transition-colors duration-300 ${
                  ...
                  {/* Active indicator */}
                  {isActive && (
                    <span className="flex-shrink-0 w-2 h-2 rounded-full bg-red-400 shadow-[0_0_8px_rgba(255,0,0,0.9)]" />
                  )}
                </button>
              );
            })}
            ...
            {selected && (
              ...
              >
                ...
                <div className="flex flex-wrap items-start gap-4 mb-2">
                  ...
                  {/* Duration - desktop */}
                  <span
                    className="hidden sm:block flex-shrink-0 px-4 py-2 bg-violet-500/20 border border-violet-500/30 rounded-lg text-violet-300 font-mono text-sm whitespace-nowrap"
                  >
                    {selected.duration}
                  </span>
                </div>
                ...
                {/* Highlight line */}
                <p
                  className="text-base text-gray-400 italic mt-4 mb-5 pl-1"
                  style={{ fontFamily: 'Outfit, sans-serif' }}
                >
                  {selected.highlight}
                </p>
