 ...
 *
 * FIXES:
 *  1. Name + subtitle + CTA all grouped in the vertical center together
 *  2. Background image restored (backgroundImage on depthRef)
 *  3. Marquee starts at opacity:0, only fades in when scroll begins
 *     AND sits behind everything (z:1, behind name at z:3)
 */
...
export const Hero = () => {
  ...
  const contentRef  = useRef<HTMLDivElement>(null);  // name + subtitle + CTA grouped
  ...
  useLayoutEffect(() => {
    ...
    // Marquee wrappers START invisible — only reveal 35 once scroll begins
    ...
    /* ── marquee infinite loops — always running, start hidden ───────── */
    const startMarquee = () => {
      if (!mq1 || !mq2) return;
    ...
    const ctx = gsap.context(() => {
      ...
      // 0.00–0.20: subtitle + CTA + chevron fade out
      tl.to([sub, cta, chev], {
        opacity: 0, y: -22,
        duration: 0.20, ease: 'power2.in', stagger: 0.03,
      }, 0);

      // Reveal marquee behind the depth container
  ...
  return (
    <div id="Hero" ref={sectionRef} style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      {/* ── MARQUEE ROWS — behind depth container ──────────── */}
      ...
      >
        ...
        {/* ── z:3  MAIN CONTENT — name + subtitle + CTA all grouped ────── */}
        {/*
          KEY FIX: everything is in ONE flex column centered both axes.
          Name → decorative line → subtitle → tagline → CTA buttons
          all stack naturally below each other, vertically centered.
        */}
        <div
          ref={contentRef}
          style={{
            ...
            alignItems:     'center',
            justifyContent: 'center',   // ← centers the whole group vertically
            textAlign:      'center',
            padding:        '0 1rem',
            gap:            0,
            pointerEvents:  'none',
        ...
        >
          ...
          {/* Thin accent line directly under name */}
          <div style={{
            marginTop:  '0.5rem',
            marginBottom: '1.4rem',
          ...
          {/* SUBTITLE + TAGLINE — directly below the line */}
          ...
          {/* CTA BUTTONS — directly below tagline */}
...
>
  ...
  />
        ...
        <div ref={chevRef} style={{
          ...
          zIndex:        6,
          animation:     'hbounce 1.6s ease-in-out infinite',
          pointerEvents: 'none',
        }}>
      ...
      {/* ── ABOUT PANEL — slides up from below ──────────────────────────── */}
          ...
          <div style={{
            ...
            <div style={{ position: 'relative' }}>
              <div style={{
                ...
                <div style={{
                  position: 'absolute',
                  inset: 0,
                  background: 'radial-gradient(circle at 30% 30%, rgba(25, 0, 255, 0.57), rgba(239,68,68,0.4))',
                  borderRadius: '50%',
                  filter: 'blur(200px)',
                ...
                <div style={{
                  ...
                  borderRadius: '26px',
                  overflow: 'hidden',
                  border: '2px solid rgba(0, 238, 255, 0)',
                  boxShadow: '-10px 20px 20px rgba(255, 0, 0, 0.4)',
                }}>
                  <img
            ...
            <div>
              <h2 style={{
                ...
                Where logic ends,<br/>
                <span style={{ color: '#ff0000' }}>Creativity finds a way</span>
              </h2>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <p style={{
                  ...
                  A software engineer specializing in AI and machine learning, focused on building intelligent, real-world systems.

Passionate about the intersection of art, design, and technology to create meaningful digital experiences.
  ...
  style={{
    ...
    boxShadow: '0 0 16px rgba(246, 92, 92, 0.25)', // base glow
  ...
  onMouseEnter={e => {
    ...
    t.style.boxShadow = '0 0 20px rgba(246,92,92,0.4), 0 0 40px rgba(139,92,246,0.65)';
    t.style.transform = 'scale(1.05)';
  }}
  onMouseLeave={e => {
    const t = e.currentTarget as HTMLDivElement;
    t.style.borderColor = 'rgba(139,92,246,0.2)';
    t.style.boxShadow = '0 0 16px rgba(246, 92, 92, 0.25)';
...
>
                ...
                onMouseEnter={e => {
                  (e.currentTarget as HTMLDivElement).style.background = 'linear-gradient(135deg, rgba(139,92,246,0.1), rgba(139,92,246,0.1))';
                }}
                onMouseLeave={e => {
                  (e.currentTarget as HTMLDivElement).style.background = 'linear-gradient(135deg, rgba(139,92,246,0), rgba(139,92,246,0))';
                }}
                />
                <div style={{ position: 'relative' }}>
                  <Icon size={32} style={{ color: '#ef4444', marginBottom: '0.75rem' }} />
                  <span style={{
                    fontSize: '2.5rem',
                    fontWeight: 700,
                    color: '#fff',
